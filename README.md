...
---
## 📋 Overview
    A customer segmentation analysis is used to identify actionable cohorts. 
    Fueled by UC Irvince, retained data, this project supports targeted      
    reward programs and targeted marketing strategies. Projecting a method to diagnose 
    and a tableau dashboard to understand market composition.      
    This project explores Customer Lifetime Value and Recency Frequency Monetary Analysis.
## Tech & Methods: ⚙️
